import './components/button/button.js';  // Componente JavaScript
import './components/card/card.js'   // Componente Card
import './components/avatar/avatar.js'   // Avatar Card
import './components/breadcrumbs/breadcrumbs.js'   // Breadcrumb Card
import './components/input/input.js'   // Input Card
import './components/badge/badge.js'   // Badge Card
...
import './components/slider/slider.js'   // Slider Card
import './components/separator/separator.js'   // Separator Card
import './components/spinner/spinner.js'   // Spinner Card
import './components/select/select.js'   // Spinner Card
import './components/pagination/pagination.js'   // Spinner Card
import './components/switch/switch.js'   // Spinner Card
